...
newbase_path=os.getcwd() + '/ppxf/newbase/'
...
tabela=open(newbase_path+ '/tabelamassasbibaseFe.txt', 'r')
...
espectros_tabela=get_info_tabela(tabela, 0.8) #Seleção do Slope
...
# Mas o programa roda só com os espectros selecionados pelo arquivo B

# Copia todos os espectros utilizados para a pasta basesGM.  
for i in espectros:
    shutil.copy(i,ppxf_path + '/basesGM/{string:s}'.format(string=i))